...
const URL_TRIADA = process.env.NEXT_PUBLIC_URL_TRIADA;

export default function ButtonGradient(props) {
  return (
    <Link href={`${URL_TRIADA}/informacion-musico/${props.musicianId}`}>
      <div className="container  pt-[21px] pb-[36px]  ">
        <button
          className={`px-1 py-1 w-[156px]  rounded-3xl lg:w-[228px] bg-gradient-to-r from-[#FF01C0] via-purple-500 to-[#01FFFE]  ${josefine.className}`}
        >
