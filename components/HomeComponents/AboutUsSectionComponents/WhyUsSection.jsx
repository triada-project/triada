...
export default function WhyUsSection() {
  return (
    <section className=" bg-[#081540] flex  sm:grid sm:grid-cols-2 sm:bg-[#9E1056] md:bg-[#081540] ">
      <div
        id="infoContainer2"
        className="flex flex-col sm:pl-5 sm:pt-5 lg:pt-32"
      >
        <div
          id="textContainer3"
          className=" flex flex-col gap-[12px] px-[48px] pt-[113px] pb-[11px] text-center sm:text-left sm:px-4  "
        >
          <h2
            className={`text-white flex font-bold text-[15px] justify-center  sm:justify-start sm:text-base lg:text-3xl  ${josefine.className}`}
          >
            ¿Por que elegirnos?
          </h2>
          <h3
            className={`text-white flex text-[18px] font-normal text-xl sm:text-base  lg:text-3xl   ${lato.className}`}
          >
            Con nosotros puedes encontrar y reservar fácilmente una banda
            musical para cualquier evento en minutos.
          </h3>
          <h3
            className={`text-white flex text-[18px] font-normal  sm:text-base lg:text-3xl  ${lato.className}`}
          >
        ...
        <div
          id="listContainer2"
          className=" flex flex-row px-[70px] pb-[75px] gap-[16px]  sm:gap-3 sm:justify-around sm:pt-4 lg:pt-8 lg:justify-start lg:pl-3 lg:gap-36 lg:pb-8  "
        >
