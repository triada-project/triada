...
export default function UpdateCardPicture() {
  return (
    <section className=" w-[328px] h-[302px] mt-11 bg-[#FAFAFA] border-dashed border-2 border-[#DEDEDE]  rounded-3xl flex flex-col pt-8">
      <div className=" w-[168px] h-[168px] rounded-full border-1 border-[#CFD8DC] bg-[#FFFFFF] flex justify-center items-center mx-20">
