...
function Payment() {
  ...
  const fetchrequestusers= async()=>{
    try {
      const response = await fetch(`http://localhost:4000/users/${eventData.musician}`, {
        headers:{
          "Content-Type": "application/json",
        }
      })   
        ...
        // <div key={index} class="flex flex-col sm:flex-row ">                
          <div key={index} className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-10">             
              ...
              <div className="m-auto" >
                  ...
                  <Image  alt="NextUI hero Image" src={userData.profilePicture}  style={{ width: '350px', height: '200px' }}  />
              </div>
              
              <div class=" p-0 ">
                  {/* <p class="text-black font-bold text-xl mb-1" >{evento.titulo_evento} </p> */}
                  <p class="text-black font-bold text-xl mb-1" >{eventData.eventName} </p>
                ...
                <div className="flex flex-col md:flex-row ">
                  ...
                  <ul class="list-none mr-9 ">
                    ...
                    <div className="flex items-center gap-1 md:gap-0 mb-2">
                      ...
                      <li className="md:text-l ">Inicio: {eventData.startHour} </li>
                    </div>
                    <div className="flex items-center gap-1 md:gap:0 mb-2">
                  ...
                  <ul class="list-none ">
                    ...
                    <div className="flex  gap-1 mb-2">
                      ...
                      <li className="md:text-l md:pt-0  pt-1 "> {eventData.status}</li>
                    </div>  
                  </ul>   
        ...
        {eventosPendientes.map((evento, index) => (
          ...
          <CardBody>
            <div className="flex items-center gap-2">
              ...
              <p className="md:text-l">Calle: {eventData.address.street} #
              {eventData.address.exteriorNumber},
              Colonia: {eventData.address.neighborhood}, Estado: {eventData.address.state}, Ciudad: {eventData.address.city},
              C.P.: {eventData.address.zipCode}</p>
            </div>
          </CardBody>
        </Card>
        ))}
