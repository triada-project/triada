...
export default function PerfilMusico() {
  return (
    <>
      ...
      <main className="	shadow-[15px_35px_60px_60px_rgba(0,0,0,0.3)] shadow-indigo-500/50  bg-white max-w-[1440px] flex flex-col items-center m-auto sm:grid sm:grid-cols-[245px_minmax(245px,_1fr)]  ">
