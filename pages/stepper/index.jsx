  ...
  return (
    <main className=" max-w-[1440px] bg-white flex flex-col items-center m-auto ">
      <div className=" flex gap-2 items-center mt-10">
        <h1 className={`${josefine.className} text-[#665DFB] text-xl`}>
          Bienvenid@ a{" "}
        </h1>
        <Image src={"/assets/svg/triada-logo.svg"} width={74} height={38} />
      </div>
      <p
        className={`${lato.className} text-center text-[#455A64] w-[328px] mt-3`}
      >
        Antes de comenzar a conectar con clientes potenciales queremos saber más
        de ti completando los siguientes pasos
      </p>
      <section className=" mt-14">
        <h2 className={`${josefine.className} text-xl text-center`}>
          Carga una imagen de perfil
        </h2>
        <p
          className={`${lato.className} text-start text-[#455A64] w-[328px] mt-3`}
        >
